...
TEST_SEARCH_FEW_SUBSTR = [
    ('', ('abc', 'a'), False, 'first', 1, {'abc': None, 'a': None}),
    ('', ('abc', 'a'), True, 'first', 1, {'abc': None, 'a': None}),
    ('', ('abc', 'a'), False, 'last', 1, {'abc': None, 'a': None}),
    ('', ('abc', 'a'), True, 'last', 1, {'abc': None, 'a': None}),
    ...
    ('ababbababa', ('aba', 'bba'), True, 'first', 3, {'aba': (0, 5, 7), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), False, 'last', 3, {'aba': (7, 5, 0), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), True, 'last', 3, {'aba': (7, 5, 0), 'bba': (3,)}),
]
